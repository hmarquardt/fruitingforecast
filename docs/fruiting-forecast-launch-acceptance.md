...
Allow about 10–15 minutes. Run production acceptance at <https://fruitingforecast.com/>. For local comparison, start the repository server and use <http://localhost:8000/>. The previous <https://hmarquardt.github.io/junkdrawer/fruiting-forecast.html> deployment remains the rollback/reference application.
